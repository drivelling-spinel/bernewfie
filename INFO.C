...
void DM_PrintActions() {
		dmprintf("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
		dmprintf("A_FreeTargMobj=%p\n", A_FreeTargMobj);
		dmprintf("A_FlameCheck=%p\n", A_FlameCheck);
		dmprintf("A_HideThing=%p\n", A_HideThing);
		dmprintf("A_UnHideThing=%p\n", A_UnHideThing);
		dmprintf("A_RestoreSpecialThing1=%p\n", A_RestoreSpecialThing1);
		dmprintf("A_RestoreSpecialThing2=%p\n", A_RestoreSpecialThing2);
		dmprintf("A_RestoreArtifact=%p\n", A_RestoreArtifact);
		dmprintf("A_Summon=%p\n", A_Summon);
		dmprintf("A_ThrustInitUp=%p\n", A_ThrustInitUp);
		dmprintf("A_ThrustInitDn=%p\n", A_ThrustInitDn);
		dmprintf("A_ThrustRaise=%p\n", A_ThrustRaise);
		dmprintf("A_ThrustBlock=%p\n", A_ThrustBlock);
		dmprintf("A_ThrustImpale=%p\n", A_ThrustImpale);
		dmprintf("A_ThrustLower=%p\n", A_ThrustLower);
		dmprintf("A_TeloSpawnC=%p\n", A_TeloSpawnC);
		dmprintf("A_TeloSpawnB=%p\n", A_TeloSpawnB);
		dmprintf("A_TeloSpawnA=%p\n", A_TeloSpawnA);
		dmprintf("A_TeloSpawnD=%p\n", A_TeloSpawnD);
		dmprintf("A_CheckTeleRing=%p\n", A_CheckTeleRing);
		dmprintf("A_FogSpawn=%p\n", A_FogSpawn);
		dmprintf("A_FogMove=%p\n", A_FogMove);
		dmprintf("A_Quake=%p\n", A_Quake);
		dmprintf("A_ContMobjSound=%p\n", A_ContMobjSound);
		dmprintf("A_Scream=%p\n", A_Scream);
		dmprintf("A_Explode=%p\n", A_Explode);
		dmprintf("A_PoisonBagInit=%p\n", A_PoisonBagInit);
		dmprintf("A_PoisonBagDamage=%p\n", A_PoisonBagDamage);
		dmprintf("A_PoisonBagCheck=%p\n", A_PoisonBagCheck);
		dmprintf("A_CheckThrowBomb=%p\n", A_CheckThrowBomb);
		dmprintf("A_NoGravity=%p\n", A_NoGravity);
		dmprintf("A_PotteryExplode=%p\n", A_PotteryExplode);
		dmprintf("A_PotteryChooseBit=%p\n", A_PotteryChooseBit);
		dmprintf("A_PotteryCheck=%p\n", A_PotteryCheck);
		dmprintf("A_CorpseBloodDrip=%p\n", A_CorpseBloodDrip);
		dmprintf("A_CorpseExplode=%p\n", A_CorpseExplode);
		dmprintf("A_LeafSpawn=%p\n", A_LeafSpawn);
		dmprintf("A_LeafThrust=%p\n", A_LeafThrust);
		dmprintf("A_LeafCheck=%p\n", A_LeafCheck);
		dmprintf("A_BridgeInit=%p\n", A_BridgeInit);
		dmprintf("A_BridgeOrbit=%p\n", A_BridgeOrbit);
		dmprintf("A_TreeDeath=%p\n", A_TreeDeath);
		dmprintf("A_PoisonShroom=%p\n", A_PoisonShroom);
		dmprintf("A_Pain=%p\n", A_Pain);
		dmprintf("A_SoAExplode=%p\n", A_SoAExplode);
		dmprintf("A_BellReset1=%p\n", A_BellReset1);
		dmprintf("A_BellReset2=%p\n", A_BellReset2);
		dmprintf("A_NoBlocking=%p\n", A_NoBlocking);
		dmprintf("A_Light0=%p\n", A_Light0);
		dmprintf("A_WeaponReady=%p\n", A_WeaponReady);
		dmprintf("A_Lower=%p\n", A_Lower);
		dmprintf("A_Raise=%p\n", A_Raise);
		dmprintf("A_FPunchAttack=%p\n", A_FPunchAttack);
		dmprintf("A_ReFire=%p\n", A_ReFire);
		dmprintf("A_FAxeAttack=%p\n", A_FAxeAttack);
		dmprintf("A_FHammerAttack=%p\n", A_FHammerAttack);
		dmprintf("A_FHammerThrow=%p\n", A_FHammerThrow);
		dmprintf("A_FSwordAttack=%p\n", A_FSwordAttack);
		dmprintf("A_FSwordFlames=%p\n", A_FSwordFlames);
		dmprintf("A_CMaceAttack=%p\n", A_CMaceAttack);
		dmprintf("A_CStaffInitBlink=%p\n", A_CStaffInitBlink);
		dmprintf("A_CStaffCheckBlink=%p\n", A_CStaffCheckBlink);
		dmprintf("A_CStaffCheck=%p\n", A_CStaffCheck);
		dmprintf("A_CStaffAttack=%p\n", A_CStaffAttack);
		dmprintf("A_CStaffMissileSlither=%p\n", A_CStaffMissileSlither);
		dmprintf("A_CFlameAttack=%p\n", A_CFlameAttack);
		dmprintf("A_CFlameRotate=%p\n", A_CFlameRotate);
		dmprintf("A_CFlamePuff=%p\n", A_CFlamePuff);
		dmprintf("A_CFlameMissile=%p\n", A_CFlameMissile);
		dmprintf("A_CHolyAttack=%p\n", A_CHolyAttack);
		dmprintf("A_CHolyPalette=%p\n", A_CHolyPalette);
		dmprintf("A_CHolySeek=%p\n", A_CHolySeek);
		dmprintf("A_CHolyCheckScream=%p\n", A_CHolyCheckScream);
		dmprintf("A_CHolyTail=%p\n", A_CHolyTail);
		dmprintf("A_CHolySpawnPuff=%p\n", A_CHolySpawnPuff);
		dmprintf("A_CHolyAttack2=%p\n", A_CHolyAttack2);
		dmprintf("A_MWandAttack=%p\n", A_MWandAttack);
		dmprintf("A_LightningReady=%p\n", A_LightningReady);
		dmprintf("A_MLightningAttack=%p\n", A_MLightningAttack);
		dmprintf("A_LightningZap=%p\n", A_LightningZap);
		dmprintf("A_LightningClip=%p\n", A_LightningClip);
		dmprintf("A_LightningRemove=%p\n", A_LightningRemove);
		dmprintf("A_LastZap=%p\n", A_LastZap);
		dmprintf("A_ZapMimic=%p\n", A_ZapMimic);
		dmprintf("A_MStaffAttack=%p\n", A_MStaffAttack);
		dmprintf("A_MStaffPalette=%p\n", A_MStaffPalette);
		dmprintf("A_MStaffWeave=%p\n", A_MStaffWeave);
		dmprintf("A_MStaffTrack=%p\n", A_MStaffTrack);
		dmprintf("A_SnoutAttack=%p\n", A_SnoutAttack);
		dmprintf("A_FireConePL1=%p\n", A_FireConePL1);
		dmprintf("A_ShedShard=%p\n", A_ShedShard);
		dmprintf("A_AddPlayerCorpse=%p\n", A_AddPlayerCorpse);
		dmprintf("A_SkullPop=%p\n", A_SkullPop);
		dmprintf("A_FreezeDeath=%p\n", A_FreezeDeath);
		dmprintf("A_FreezeDeathChunks=%p\n", A_FreezeDeathChunks);
		dmprintf("A_CheckBurnGone=%p\n", A_CheckBurnGone);
		dmprintf("A_CheckSkullFloor=%p\n", A_CheckSkullFloor);
		dmprintf("A_CheckSkullDone=%p\n", A_CheckSkullDone);
		dmprintf("A_SpeedFade=%p\n", A_SpeedFade);
		dmprintf("A_IceSetTics=%p\n", A_IceSetTics);
		dmprintf("A_IceCheckHeadDone=%p\n", A_IceCheckHeadDone);
		dmprintf("A_PigPain=%p\n", A_PigPain);
		dmprintf("A_PigLook=%p\n", A_PigLook);
		dmprintf("A_PigChase=%p\n", A_PigChase);
		dmprintf("A_FaceTarget=%p\n", A_FaceTarget);
		dmprintf("A_PigAttack=%p\n", A_PigAttack);
		dmprintf("A_QueueCorpse=%p\n", A_QueueCorpse);
		dmprintf("A_Look=%p\n", A_Look);
		dmprintf("A_Chase=%p\n", A_Chase);
		dmprintf("A_CentaurAttack=%p\n", A_CentaurAttack);
		dmprintf("A_CentaurAttack2=%p\n", A_CentaurAttack2);
		dmprintf("A_SetReflective=%p\n", A_SetReflective);
		dmprintf("A_CentaurDefend=%p\n", A_CentaurDefend);
		dmprintf("A_UnSetReflective=%p\n", A_UnSetReflective);
		dmprintf("A_CentaurDropStuff=%p\n", A_CentaurDropStuff);
		dmprintf("A_CheckFloor=%p\n", A_CheckFloor);
		dmprintf("A_DemonAttack1=%p\n", A_DemonAttack1);
		dmprintf("A_DemonAttack2=%p\n", A_DemonAttack2);
		dmprintf("A_DemonDeath=%p\n", A_DemonDeath);
		dmprintf("A_Demon2Death=%p\n", A_Demon2Death);
		dmprintf("A_WraithRaiseInit=%p\n", A_WraithRaiseInit);
		dmprintf("A_WraithRaise=%p\n", A_WraithRaise);
		dmprintf("A_WraithInit=%p\n", A_WraithInit);
		dmprintf("A_WraithLook=%p\n", A_WraithLook);
		dmprintf("A_WraithChase=%p\n", A_WraithChase);
		dmprintf("A_WraithFX3=%p\n", A_WraithFX3);
		dmprintf("A_WraithMelee=%p\n", A_WraithMelee);
		dmprintf("A_WraithMissile=%p\n", A_WraithMissile);
		dmprintf("A_WraithFX2=%p\n", A_WraithFX2);
		dmprintf("A_MinotaurFade1=%p\n", A_MinotaurFade1);
		dmprintf("A_MinotaurFade2=%p\n", A_MinotaurFade2);
		dmprintf("A_MinotaurLook=%p\n", A_MinotaurLook);
		dmprintf("A_MinotaurChase=%p\n", A_MinotaurChase);
		dmprintf("A_MinotaurRoam=%p\n", A_MinotaurRoam);
		dmprintf("A_MinotaurAtk1=%p\n", A_MinotaurAtk1);
		dmprintf("A_MinotaurDecide=%p\n", A_MinotaurDecide);
		dmprintf("A_MinotaurAtk2=%p\n", A_MinotaurAtk2);
		dmprintf("A_MinotaurAtk3=%p\n", A_MinotaurAtk3);
		dmprintf("A_MinotaurCharge=%p\n", A_MinotaurCharge);
		dmprintf("A_SmokePuffExit=%p\n", A_SmokePuffExit);
		dmprintf("A_MinotaurFade0=%p\n", A_MinotaurFade0);
		dmprintf("A_MntrFloorFire=%p\n", A_MntrFloorFire);
		dmprintf("A_SerpentChase=%p\n", A_SerpentChase);
		dmprintf("A_SerpentHumpDecide=%p\n", A_SerpentHumpDecide);
		dmprintf("A_SerpentUnHide=%p\n", A_SerpentUnHide);
		dmprintf("A_SerpentRaiseHump=%p\n", A_SerpentRaiseHump);
		dmprintf("A_SerpentLowerHump=%p\n", A_SerpentLowerHump);
		dmprintf("A_SerpentHide=%p\n", A_SerpentHide);
		dmprintf("A_SerpentBirthScream=%p\n", A_SerpentBirthScream);
		dmprintf("A_SetShootable=%p\n", A_SetShootable);
		dmprintf("A_SerpentCheckForAttack=%p\n", A_SerpentCheckForAttack);
		dmprintf("A_UnSetShootable=%p\n", A_UnSetShootable);
		dmprintf("A_SerpentDiveSound=%p\n", A_SerpentDiveSound);
		dmprintf("A_SerpentWalk=%p\n", A_SerpentWalk);
		dmprintf("A_SerpentChooseAttack=%p\n", A_SerpentChooseAttack);
		dmprintf("A_SerpentMeleeAttack=%p\n", A_SerpentMeleeAttack);
		dmprintf("A_SerpentMissileAttack=%p\n", A_SerpentMissileAttack);
		dmprintf("A_SerpentHeadPop=%p\n", A_SerpentHeadPop);
		dmprintf("A_SerpentSpawnGibs=%p\n", A_SerpentSpawnGibs);
		dmprintf("A_SerpentHeadCheck=%p\n", A_SerpentHeadCheck);
		dmprintf("A_FloatGib=%p\n", A_FloatGib);
		dmprintf("A_DelayGib=%p\n", A_DelayGib);
		dmprintf("A_SinkGib=%p\n", A_SinkGib);
		dmprintf("A_BishopDecide=%p\n", A_BishopDecide);
		dmprintf("A_BishopDoBlur=%p\n", A_BishopDoBlur);
		dmprintf("A_BishopSpawnBlur=%p\n", A_BishopSpawnBlur);
		dmprintf("A_BishopChase=%p\n", A_BishopChase);
		dmprintf("A_BishopAttack=%p\n", A_BishopAttack);
		dmprintf("A_BishopAttack2=%p\n", A_BishopAttack2);
		dmprintf("A_BishopPainBlur=%p\n", A_BishopPainBlur);
		dmprintf("A_BishopPuff=%p\n", A_BishopPuff);
		dmprintf("A_SetAltShadow=%p\n", A_SetAltShadow);
		dmprintf("A_BishopMissileWeave=%p\n", A_BishopMissileWeave);
		dmprintf("A_BishopMissileSeek=%p\n", A_BishopMissileSeek);
		dmprintf("A_DragonInitFlight=%p\n", A_DragonInitFlight);
		dmprintf("A_DragonFlap=%p\n", A_DragonFlap);
		dmprintf("A_DragonFlight=%p\n", A_DragonFlight);
		dmprintf("A_DragonAttack=%p\n", A_DragonAttack);
		dmprintf("A_DragonPain=%p\n", A_DragonPain);
		dmprintf("A_DragonCheckCrash=%p\n", A_DragonCheckCrash);
		dmprintf("A_DragonFX2=%p\n", A_DragonFX2);
		dmprintf("A_ESound=%p\n", A_ESound);
		dmprintf("A_EttinAttack=%p\n", A_EttinAttack);
		dmprintf("A_DropMace=%p\n", A_DropMace);
		dmprintf("A_FiredRocks=%p\n", A_FiredRocks);
		dmprintf("A_UnSetInvulnerable=%p\n", A_UnSetInvulnerable);
		dmprintf("A_FiredChase=%p\n", A_FiredChase);
		dmprintf("A_FiredAttack=%p\n", A_FiredAttack);
		dmprintf("A_FiredSplotch=%p\n", A_FiredSplotch);
		dmprintf("A_SmBounce=%p\n", A_SmBounce);
		dmprintf("A_IceGuyLook=%p\n", A_IceGuyLook);
		dmprintf("A_IceGuyChase=%p\n", A_IceGuyChase);
		dmprintf("A_IceGuyAttack=%p\n", A_IceGuyAttack);
		dmprintf("A_IceGuyDie=%p\n", A_IceGuyDie);
		dmprintf("A_IceGuyMissilePuff=%p\n", A_IceGuyMissilePuff);
		dmprintf("A_IceGuyMissileExplode=%p\n", A_IceGuyMissileExplode);
		dmprintf("A_ClassBossHealth=%p\n", A_ClassBossHealth);
		dmprintf("A_FastChase=%p\n", A_FastChase);
		dmprintf("A_FighterAttack=%p\n", A_FighterAttack);
		dmprintf("A_ClericAttack=%p\n", A_ClericAttack);
		dmprintf("A_MageAttack=%p\n", A_MageAttack);
		dmprintf("A_SorcSpinBalls=%p\n", A_SorcSpinBalls);
		dmprintf("A_SpeedBalls=%p\n", A_SpeedBalls);
		dmprintf("A_SpawnFizzle=%p\n", A_SpawnFizzle);
		dmprintf("A_SorcBossAttack=%p\n", A_SorcBossAttack);
		dmprintf("A_SorcBallOrbit=%p\n", A_SorcBallOrbit);
		dmprintf("A_SorcBallPop=%p\n", A_SorcBallPop);
		dmprintf("A_BounceCheck=%p\n", A_BounceCheck);
		dmprintf("A_SorcFX1Seek=%p\n", A_SorcFX1Seek);
		dmprintf("A_SorcFX2Split=%p\n", A_SorcFX2Split);
		dmprintf("A_SorcFX2Orbit=%p\n", A_SorcFX2Orbit);
		dmprintf("A_SorcererBishopEntry=%p\n", A_SorcererBishopEntry);
		dmprintf("A_SpawnBishop=%p\n", A_SpawnBishop);
		dmprintf("A_SorcFX4Check=%p\n", A_SorcFX4Check);
		dmprintf("A_KoraxStep2=%p\n", A_KoraxStep2);
		dmprintf("A_KoraxChase=%p\n", A_KoraxChase);
		dmprintf("A_KoraxStep=%p\n", A_KoraxStep);
		dmprintf("A_KoraxDecide=%p\n", A_KoraxDecide);
		dmprintf("A_KoraxMissile=%p\n", A_KoraxMissile);
		dmprintf("A_KoraxCommand=%p\n", A_KoraxCommand);
		dmprintf("A_KoraxBonePop=%p\n", A_KoraxBonePop);
		dmprintf("A_KSpiritRoam=%p\n", A_KSpiritRoam);
		dmprintf("A_KBoltRaise=%p\n", A_KBoltRaise);
		dmprintf("A_KBolt=%p\n", A_KBolt);
		dmprintf("A_BatSpawnInit=%p\n", A_BatSpawnInit);
		dmprintf("A_BatSpawn=%p\n", A_BatSpawn);
		dmprintf("A_BatMove=%p\n", A_BatMove);
		dmprintf("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
	}
#endif
...
#ifdef(PATCH12)
{SPR_CENT,6,6,A_CentaurPain,S_CENTAUR_PAIN2,0,0},      // S_CENTAUR_PAIN1
{SPR_CENT,4,5,A_SetReflective,S_CENTAUR_PAIN3,0,0},     // S_CENTAUR_PAIN2
{SPR_CENT,4,10,A_CentaurDefend,S_CENTAUR_PAIN4,0,0},    // S_CENTAUR_PAIN3
{SPR_CENT,4,10,A_CentaurDefend,S_CENTAUR_PAIN5,0,0},    // S_CENTAUR_PAIN4
{SPR_CENT,4,10,A_CentaurDefend,S_CENTAUR_PAIN6,0,0},    // S_CENTAUR_PAIN5
